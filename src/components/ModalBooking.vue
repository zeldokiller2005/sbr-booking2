    ...
    <div class="modal-content">
      ...
      <div class="form-group">
        ...
        <div class="select-wrapper">
          <span class="placeholder">Выберите мероприятие</span>
...
.select-wrapper .placeholder { color: #888; }
.select-wrapper .arrow-down { color: #888; font-size: 12px; transform: scale(0.8); }
